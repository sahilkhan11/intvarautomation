        ...
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6 p-4 md:p-0">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-3xl md:text-5xl font-heading font-bold uppercase tracking-tight text-[#0a0a0a]">{post.title}</h2>
            ...
            <div className="mt-4">
              <Link href={`/blog/${post.slug}`} className="inline-flex items-center gap-3 text-sm font-bold uppercase tracking-widest hover:opacity-70 transition-opacity text-[#0a0a0a] group-btn">
                <span className="underline underline-offset-4">Read Article</span>
